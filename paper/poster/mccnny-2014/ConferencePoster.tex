...
\centering
\hspace*{-.5cm}\includegraphics[height=4.2cm]{img/deerins}  \includegraphics[width=4cm]{img/hist1000_xmean_alpha07} \\
One Run with $\alpha=.05$, $\gamma=.05$, $P=230000$ and Histogram of the Mean Population with 1000 iterations\\
\includegraphics[width=5.2cm]{img/meanDeerByAlpha_boxplot}  \includegraphics[width=5.2cm]{img/stdDevDeerbyAlpha_boxplot} \\
Boxplots of Sample Mean and Sample Standard Deviation of Deer Population \\
\includegraphics[width=5.25cm]{img/fundMeanContour} \includegraphics[width=5.25cm]{img/fundSDContour} \\
