...
A fundamental example is the Logistic Model: 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Mutual Predation Solution} {name=Zombie,column=1,span=1,above=bottom}{
...
\centering
\hspace*{-.5cm}
\includegraphics[width=15cm, height=6.2cm]{img/ScaledPlots}
...
$$F(q_1,q_2,\cdots, q_n)=0 \hspace{.5em} \text{ or equivalently} \hspace{.5em} q_1=f(q_2, \cdots, q_n)$$ 
 }

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Process}{name=solve,column=0,below=definition,above=bottom}{
\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Mutual Predation Example}{name=history,column=1,below=simple}
{
...
Thanks to Dr. Joel Foisy, Dr. Kelly Black, The National Science Foundation (DSM-1262737) and The National Security Agency for their involvement in this program. 
%\smaller
