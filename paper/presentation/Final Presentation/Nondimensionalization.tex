...
\begin{frame}{Phase Plane}
  ...
  \begin{columns}
    \column{.65\textwidth}
       \includegraphics[height=6cm]{img/RplotMain}
    \column{.35\textwidth}
    \begin{itemize}
...
\begin{frame}
 What happens if we change the parameters to $\gamma = .85$ and $\delta = .8$ \\
      \begin{center} \includegraphics[height=7cm]{img/Rplot1} \end{center}
\end{frame}

\begin{frame}
 If we change the parameters to $\alpha = .9, \beta = .2, \gamma = .8$ and $\delta = .4$ \\
     \begin{center}  \includegraphics[height=7cm]{img/Rplot2} \end{center}
\end{frame}

\begin{frame}
 If we change the parameters to $\alpha = .5, \beta = .5, \gamma = .8$ and $\delta = .4$ \\
     \begin{center} \includegraphics[height=7cm]{img/Rplot3} \end{center}
\end{frame}

\begin{frame}
	If we change the parameters to $\alpha = .95, \beta = .95, \gamma = .8$ and $\delta = .4$ \\
     \begin{center} \includegraphics[height=7cm]{img/Rplot4} \end{center}
\end{frame}
